...
const AboutUs = () => {
  return (
    <div className="bg-yellow-100 p-10 mt-14" id="about">
      {/* صفحة من نحن */}
      <h1 className="text-center text-primaryButton text-3xl font-bold  mb-8">عن دليل تعليمك</h1>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
        {/* الرؤية */}
        <div className=" border-pinkb p-6 rounded-lg shadow-md  border-2 border-body text-navbar outline-none  rounded-lg shadow-md transition-transform duration-300 hover:scale-105 focus:ring-blue-500">
          <h2 className="text-xl  text-customGreen2 font-bold mb-4 bg-white text-center py-2">
            الرؤية
          </h2>
          <p>
        ...
        {/* الرسالة */}
        <div className=" border-pinkb p-6 rounded-lg shadow-md  border-2 border-body text-navbar outline-none  rounded-lg shadow-md transition-transform duration-300 hover:scale-105 focus:ring-blue-500">
          <h2 className="text-xl text-customGreen2  text-blue-900 font-bold mb-4 bg-white text-center py-2">
            رسالتنا
          </h2>
...
نؤمن بأن الابتكار هو الأساس، والتكنولوجيا هي الوسيلة لتحقيق التغيير الإيجابي.
      ...
      <div className="grid grid-cols-2 ">
        <div className="mt-10 border-pinkb   p-6 rounded-lg   border-2 border-body text-navbar outline-none  rounded-lg shadow-md transition-transform duration-300 hover:scale-105 focus:ring-blue-500">
          <h2 className="text-xl   text-customGreen2  text-blue-900 font-bold mb-4 bg-white text-center py-2 ">
            شعارنا
          </h2>
      ...
      {/* نصائح */}
      <div className="mt-10 p-6 border-customGreen2 rounded-lg shadow-md  border-2 border-body text-navbar outline-none   transition-transform duration-300 hover:scale-105 focus:ring-blue-500">
        <h2 className="text-xl  text-customGreen2 font-bold mb-4 bg-white text-center py-2">
          {" "}
